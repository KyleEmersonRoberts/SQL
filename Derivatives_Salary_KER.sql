...
To make the results more interesting, I've set a bench mark to show which employees had the highest rate of change in salary over a period of five years
*/
...
where 	S1.emp_no=S2.emp_no and datediff(s2.to_date,s1.from_date) > 400*5 /* this allows you to filter the results of the derivative to custom time spans*/ 
